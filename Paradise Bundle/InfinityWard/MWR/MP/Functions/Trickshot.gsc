...
slide()
{
        ...
        self.spawnedSlide = spawnscriptmodel(slideOrigin, "com_plasticcase_green_big", self.spawnedSlide.angles, (0,0,0), level.airdropcratecollision);
...
doSpawnOption(selection)
{
    switch(selection)
    {
        case "bounce":
            ...
            self.spawnedTrampoline setModel("com_plasticcase_green_big");
        ...
        if(!level.oomUtilDisabled)
        {
            ...
            {    
                ...
                for(d = -3; d < 3; d++)
                    self.spawnedplat[i][d] = spawnScriptModel(startpos + (d * 56, i * 30, 0),"com_plasticcase_green_big",(0,0,0),0,level.airDropCrateCollision);
            }
        }
        else
        ...
        if(!level.oomUtilDisabled)
        {
            ...
            self.spawnedcrate = spawnscriptmodel(self.origin + (0, 0, -15), "com_plasticcase_green_big", (0,0,0), 
