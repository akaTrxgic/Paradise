//not my code, pulled from killcam mod patch_mp.ff (author unknown)
beginFK()
{
...
CreateFKMenu( victim , attacker)
{
    ...
    self.credits _setText("   ");
    self.fk_title_low _setText(attacker.name);
    
    if( !level.killcam_style )
        self.fk_title _setText("Game Winning Kill");
    else
        self.fk_title _setText("Round Winning Kill");
}
...
hook maps\mp\gametypes\_globallogic::endGame( winner, endReasonText )
{
