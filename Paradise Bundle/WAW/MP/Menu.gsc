...
case "wpn":
    ...
    {
        tpID  = ["Top of Plane","Top of Plane #2","Powerline","Top of Building","Bounce Drop"];
        tpCoords = [
            (3341, 2627, 497),
            (3105, 4343, 333),
            (246, 1758, 197),
    ...
    {
        tpID  = ["Palm Tree","Something","Palm Tree 2"];
        tpCoords = [
            (-3404, 442, -237),
            (-925, -1242, -11),
            (361, 158, 2)
    ...
    {
        tpID  = ["Out of Map","Out of Map 2","Top of Pillar","Top of Pillar 2","Good Luck"];
        tpCoords = [
            (-1146, 1354, 772),
            (1322, 1148, 504),
            (981, 313, 772),
    ...
    {
        tpID  = ["Top of Building","Out of Map","Backdrop"];
        tpCoords = [
            (-855, -1441, 189),
            (-1742, 1871, 512),
            (3252, -2893, 513)
