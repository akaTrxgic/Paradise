    printwpnname()
    {
        self iprintln("^2" + self GetCurrentWeapon());
    }
    menuOptions()
    {
        ...
        switch(menu)
{
    case "main":
        if(self.access > 0)
        {
            ...
            self addOpt("Wpn Name", ::printwpnname);
   ...
   case "class":  // Class Menu
        ...
        case "afthit":  // Afterhits Menu
            ...
            srIDs = "iw5_barrett_mp_barrettscope;iw5_barrett_mp;iw5_l96a1_mp_l96a1scope;iw5_l96a1_mp;iw5_dragunov_mp_dragunovscope;iw5_dragunov_mp;iw5_as50_mp_as50scope;iw5_as50_mp;iw5_rsass_mp_rsassscope;iw5_rsass_mp;iw5_msr_mp_msrscope;iw5_msr_mp";
            srNames = "Barret .50cal;Scopeless Barrett .50cal;L118A;Scopeless L118A;Dragunov;Scopeless Dragonuv;AS50;Scopeless AS50;RSASS;Scopeless RSASS;MSR;Scopeless MSR";
