        ...
        switch(menu)
{
   ...
   case "class":  // Class Menu
        ...
        case "acc":
            ...
            self addOpt("Paradise Class Names", ::doClassNames, "paradise");
            self addOpt("Colored Class Names", ::doClassNames, "colored");
            self addOpt("Button Class Names", ::doClassNames, "buttons");
        break;
