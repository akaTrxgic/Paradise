sentryBind(num)
{
    ...
    { 
        self iPrintLn("Walking Sentry Bind [[^1OFF^7]^7]");
...
predBind(num)
{
    ...
    { 
        self iPrintLn("Laptop bind [[^1OFF^7]^7]");
...
bombBind(num)
{
    ...
    { 
        self iPrintLn("Bomb bind [[^1OFF^7]^7]");
        self.bomb = undefined; 
    }
}
trgrBind(num)
{
    ...
    { 
        self iPrintLn("Trigger bind [[^1OFF^7]^7]");
        self.trgr = undefined; 
    }
}
doTrigger()
...
empBind(num)
{
    ...
    { 
        self iPrintLn("Third Eye Bind [[^1OFF^7]^7]");
...
Canzoom(num)
{
    ...
    { 
        self iPrintLn("Canzoom bind [[^1OFF^7]^7]");
...
nacModBind(num)
{
    ...
    { 
        self iPrintLn("Nac Bind [[^1OFF^7]^7]");
...
skreeBind(num)
{
    ...
    { 
        self iPrintLn("Skree Bind [[^1OFF^7]^7]");
...
gFlipBind(num)
{
    ...
    { 
        self iPrintLn("GFlip bind [[^1OFF^7]^7]");
