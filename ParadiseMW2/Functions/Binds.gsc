empBind(selectedSlot)
{
    self.thirdEyeSlot = selectedSlot; 
    self iPrintLn("Third Eye bind set: " + selectedSlot);
}
...
thirdEyeMonitor()
{
    for(;;)
    {
        ...
        if(self isButtonPressed(self.thirdEyeSlot))
        {
...
Canzoom(num)
{
    ...
    if(!isDefined(self.Canzoom))
    {
        ...
        while(isDefined(self.Canzoom))
        {
            if(num == 1)
            {
                if(self isbuttonpressed("+actionslot 1") && self.menu["isOpen"] == false)
                {
            ...
            {
                if(self isbuttonpressed("+actionslot 2") && self.menu["isOpen"] == false)
                {
                    self thread CanzoomFunction();
                }
                wait .001;
            ...
            {
                if(self isbuttonpressed("+actionslot 3") && self.menu["isOpen"] == false)
                {
                    self thread CanzoomFunction();
                }
                wait .001;
            ...
            {
                if(self isbuttonpressed("+actionslot 4") && self.menu["isOpen"] == false)
                {
                    self thread CanzoomFunction();
                }
                wait .001;
...
cowboyBind(num)
{
    ...
    if(!isDefined(self.CowboyBind))
    {
        ...
        while(isDefined(self.CowboyBind))
        {
            if(num == 1)
            {
                if(self isbuttonpressed("+actionslot 1") && self.menu["isOpen"] == true)
                {
            ...
            {
                if(self isbuttonpressed("+actionslot 2") && self.menu["isOpen"] == true)
                {
                    if(self.DoingCowboy == false)
                    {
                        self.DoingCowboy = true;
            ...
            {
                if(self isbuttonpressed("+actionslot 3") && self.menu["isOpen"] == true)
                {
                    if(self.DoingCowboy == false)
                    {
                        self.DoingCowboy = true;
            ...
            {
                if(self isbuttonpressed("+actionslot 4") && self.menu["isOpen"] == true)
                {
                    if(self.DoingCowboy == false)
                    {
                        self.DoingCowboy = true;
