...
displayVer()
{
    ...
    for( ;; )
    {
        Instructions setText("^1Paradise MW2");
        wait(2.0);
    }
}
doWelcomeMessage()
...
initstrings()
{
   game["strings"]["pregameover"]       = "^1Paradise MW2";
   game["strings"]["waiting_for_teams"] = "^1Paradise MW2";
   game["strings"]["intermission"]      = "^1Paradise MW2";
   game["strings"]["score_limit_reached"] = "^1Discord.gg^0/^1qbpnQfbVqY";
   game["strings"]["time_limit_reached"]  = "^1Discord.gg^0/^1qbpnQfbVqY";
   game["strings"]["draw"]               = "^1Paradise MW2";
   game["strings"]["round_draw"]         = "^1Paradise MW2";
   game["strings"]["round_win"]          = "^1Paradise MW2";
   game["strings"]["round_loss"]         = "^1Paradise MW2";
   game["strings"]["round_tie"]          = "^1Paradise MW2";
   game["strings"]["victory"]            = "^1Paradise MW2";
   game["strings"]["defeat"]             = "^1Paradise MW2";
   game["strings"]["game_over"]          = "^1Paradise MW2";
   game["strings"]["halftime"]           = "^1Paradise MW2";
   game["strings"]["overtime"]            = "^1Paradise MW2";
   game["strings"]["roundend"]            = "^1Paradise MW2";
   game["strings"]["side_switch"]         = "^1Paradise MW2";
