    ...
    menuOptions()
    {
        ...
        switch( menu )
        {
            ...
            case "Submenu1":
                ...
                testIDs = strtok("ABC;DEF;GHI;JKL", ";");
                testNames = strtok("Test ABC;Test DEF;Test GHI;Test JKL", ";");
    ...
    drawMenu()
    {
        ...
        self.menu["UI"]["MENU_TITLE"] = self createtext("objective", 1.8, "TOPLEFT", "CENTER", self.presets["X"] + 90, self.presets["Y"] - 100, 5, 1, level.MenuName, self.presets["MenuTitle_Color"]);
