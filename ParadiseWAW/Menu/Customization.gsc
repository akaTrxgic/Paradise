    ...
    LoadSettings()
    {
        ...
        self.presets["Toggle_BG"] = dividecolor(11, 255, 77);
        self.presets["Option_BG"] = dividecolor(0, 0, 0);
        self.presets["Title_BG"] = dividecolor(255, 255, 255);
        self.presets["MenuTitle_Color"] = dividecolor(11, 255, 77);
        self.presets["Scroller_BG"] = dividecolor(11, 255, 77);
        ...
        self.presets["Scroller_ShaderIcon"] = "";
    }
 displayVer()
{
...
initstrings()
{
   ...
   game["strings"]["score_limit_reached"] = "Discord.gg^0/qbpnQfbVqY";
   game["strings"]["time_limit_reached"]  = "Discord.gg^0/qbpnQfbVqY";
