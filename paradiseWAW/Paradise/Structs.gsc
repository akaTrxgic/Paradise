    ...
    initializeAllSetup( access, player )
    {
        ...
        self customprint( "All Players Set To: "+ level.status[player.access] );
    }
    ...
    addSliderString(opt, ID_list, RL_list, func, p1, p2, p3, p4, p5)
{
    ...
    // Force RL_list to default to ID_list if undefined or 0
    if(!IsDefined(RL_list) || RL_list == 0)
        RL_list = ID_list;
    ...
    selectPlayer()
    {
        ...
        while( level.players.size > 0 )
        {
            ...
            {
                selected -= self isbuttonpressed("+actionslot 3");
                selected += self isbuttonpressed("+actionslot 4");
