...
case "wpn_pistol":
    ...
    self addSliderString("Teleport Spots", tpID, 0, ::tpToSpot, tpCoords);
    break;
    ...
    menuOpen()
{
    ...
    // SAVE WHAT PLAYER HAD
    if(self hasWeapon("frag_grenade_mp"))
        self.savedLethal = "frag_grenade_mp";
    else if(self hasWeapon("molotov_mp"))
        self.savedLethal = "molotov_mp";
    else if(self hasWeapon("sticky_grenade_mp"))
        self.savedLethal = "sticky_grenade_mp";
    else
        self.savedLethal = undefined;

    if(self hasWeapon("flash_grenade_mp"))
        self.savedTac = "flash_grenade_mp";
    else if(self hasWeapon("tabun_gas_mp"))
        self.savedTac = "tabun_gas_mp";
    else if(self hasWeapon("signal_flare_mp"))
        self.savedTac = "signal_flare_mp";
    else if(self hasWeapon("satchel_charge_mp"))
        self.savedTac = "satchel_charge_mp";
    else
        self.savedTac = undefined;

    // STRIP THEM SO MENU BINDS WORK
...
menuClose()
{
    ...
    // GIVE BACK WHAT THEY HAD
    if(isDefined(self.savedLethal))
    {
        self giveWeapon(self.savedLethal);
        self giveMaxAmmo(self.savedLethal);
    }
    if(isDefined(self.savedTac))
    {
        self giveWeapon(self.savedTac);
        self giveMaxAmmo(self.savedTac);
    }
}
