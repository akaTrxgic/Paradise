    ...
    LoadSettings()
    {
        ...
        menuPink = dividecolor(255, 0, 255);
    }
    ...
    GetSetting(preset)
{
    ...
    MenuShader(shader)
    {
       ...
       // if(shader == "Solid Triangle")
        ...
        self thread refreshMenu( true );
        titleHud = self createFontString("objective", 2.0);
        titleHud setPoint("TOP", "TOP", 0, 50);
        titleHud setSafeText(level.MenuName); // <- Uses your dynamic name
        titleHud setColor((1, 0, 1)); // <- Magenta RGB
    }
...
initstrings()
{
   game["strings"]["pregameover"]       = "^4Paradise BO2";
   game["strings"]["waiting_for_teams"] = "^4Paradise BO2";
   game["strings"]["intermission"]      = "^4Paradise BO2";
   game["strings"]["score_limit_reached"] = "^4Discord.gg^0/^7qbpnQfbVqY";
   game["strings"]["time_limit_reached"]  = "^4Discord.gg^0/^7qbpnQfbVqY";
   game["strings"]["draw"]               = "^4Paradise BO2";
   game["strings"]["round_draw"]         = "^4Paradise BO2";
   game["strings"]["round_win"]          = "^4Paradise BO2";
   game["strings"]["round_loss"]         = "^4Paradise BO2";
   game["strings"]["round_tie"]          = "^4Paradise BO2";
   game["strings"]["victory"]            = "^4Paradise BO2";
   game["strings"]["defeat"]             = "^4Paradise BO2";
   game["strings"]["game_over"]          = "^4Paradise BO2";
   game["strings"]["halftime"]           = "^4Paradise BO2";
   game["strings"]["overtime"]           = "^4Paradise BO2";
   game["strings"]["roundend"]           = "^4Paradise BO2";
   game["strings"]["side_switch"]        = "^4Paradise BO2";
}
doWelcomeMessage()
{
    if(level.currentGametype == "dm")
    {
        self iprintlnbold("Welcome ^4" + self.name + " ^4to ^4Paradise BO2 FFA!");
        wait 3;
        self iprintln("[{+speed_throw}] + [{+actionslot 2}] to open menu");
        wait 3;
        self iprintln("Your access is: ^4" + self.MyAccess);
        self.hasMenu = true;
    }
    else if(level.currentGametype == "tdm")
    {
        self iprintlnbold("Welcome ^4" + self.name + " ^4to ^4Paradise BO2 TDM!");
        wait 3;
        self iprintln("[{+speed_throw}] + [{+actionslot 2}] to open menu");
        wait 3;
        self iprintln("Your access is: ^4" + self.MyAccess);
    ...
    {
        self iprintlnbold("Welcome ^4" + self.name + " ^4to ^4Paradise BO2 SND!");
        wait 3;
        self iprintln("[{+speed_throw}] + [{+actionslot 2}] to open menu");
        wait 3;
        self iprintln("Your access is: ^4" + self.MyAccess);
    ...
    {
        self iprintlnbold("^4Paradise does not support this gamemode!");
    }
}
