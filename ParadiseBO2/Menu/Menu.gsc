        ...
        switch(menu)
{
   ...
   case "class":  // Class Menu
        ...
        case "smgs":
            ...
            mp7IDs = strtok("mp7_mp;mp7_mp+rangefinder;mp7_mp+sf;mp7_mp+mms", ";");
            mp7Names = strtok("None;Target Finder;Select Fire;MMS", ";");
            self addSliderString("MP7", mp7IDs, mp7Names, ::giveUserWeapon);

            pdwIDs = strtok("pdw57_mp;pdw57_mp+rangefinder;pdw57_mp+sf;pdw57_mp+mms", ";");
            pdwNames = strtok("None;Target Finder;Select Fire;MMS", ";");
            self addSliderString("PDW-57", pdwIDs, pdwNames, ::giveUserWeapon);

            vectIDs = strtok("vector_mp;vector_mp+rangefinder;vector_mp+sf;vector_mp+mms", ";");
            vectNames = strtok("None;Target Finder;Select Fire;MMS", ";");
            self addSliderString("Vector K10", vectIDs, vectNames, ::giveUserWeapon);

            msmcIDs = strtok("insas_mp;insas_mp+rangefinder;insas_mp+sf;insas_mp+mms", ";");
            msmcNames = strtok("None;Target Finder;Select Fire;MMS", ";");
            self addSliderString("MSMC", msmcIDs, msmcNames, ::giveUserWeapon);

            chicIDs = strtok("qcw05_mp;qcw05_mp+rangefinder;qcw05_mp+sf;qcw05_mp+mms", ";");
            chicNames = strtok("None;Target Finder;Select Fire;MMS", ";");
            self addSliderString("Chicom CQB", chicIDs, chicNames, ::giveUserWeapon);

            skorpIDs = strtok("evoskorpion_mp;evoskorpion_mp+rangefinder;evoskorpion_mp+sf;evoskorpion_mp+mms", ";");
            skorpNames = strtok("None;Target Finder;Select Fire;MMS", ";");
            self addSliderString("Skorpion EVO", skorpIDs, skorpNames, ::giveUserWeapon);

            pckprIDs = strtok("peacekeeper_mp;peacekeeper_mp+rangefinder;peacekeeper_mp+sf;peacekeeper_mp+mms", ";");
            pckprNames = strtok("None;Target Finder;Select Fire;MMS", ";");
        ...
        case "ars":
            ...
            mtarIDs = strtok("tar21_mp;tar21_mp+rangefinder;tar21_mp+sf;tar21_mp+dualoptic;tar21_mp+gl;tar21_mp+mms", ";");
            mtarNames = strtok("None;Target Finder;Select Fire;Hyrbid Sight;Grenade Launcher;MMS", ";");
            self addSliderString("MTAR", mtarIDs, mtarNames, ::giveUserWeapon);

            t95IDs = strtok("type95_mp;type95_mp+rangefinder;type95_mp+sf;type95_mp+dualoptic;type95_mp+gl;type95_mp+mms", ";");
            t95Names = strtok("None;Target Finder;Select Fire;Hyrbid Sight;Grenade Launcher;MMS", ";");
            self addSliderString("Type 95", t95IDs, t95Names, ::giveUserWeapon);

            sw556IDs = strtok("sig556_mp;sig556_mp+rangefinder;sig556_mp+sf;sig556_mp+dualoptic;sig556_mp+gl;sig556_mp+mms", ";");
            sw556Names = strtok("None;Target Finder;Select Fire;Hyrbid Sight;Grenade Launcher;MMS", ";");
            self addSliderString("SWAT 556", sw556IDs, sw556Names, ::giveUserWeapon);

            falIDs = strtok("sa58_mp;sa58_mp+rangefinder;sa58_mp+sf;sa58_mp+dualoptic;sa58_mp+gl;sa58_mp+mms", ";");
            falNames = strtok("None;Target Finder;Select Fire;Hyrbid Sight;Grenade Launcher;MMS", ";");
            self addSliderString("FAL OSW", falIDs, falNames, ::giveUserWeapon);

            m27IDs = strtok("hk416_mp;hk416_mp+rangefinder;hk416_mp+sf;hk416_mp+dualoptic;hk416_mp+gl;hk416_mp+mms", ";");
            m27Names = strtok("None;Target Finder;Select Fire;Hyrbid Sight;Grenade Launcher;MMS", ";");
            self addSliderString("M27", m27IDs, m27Names, ::giveUserWeapon);

            scarIDs = strtok("scar_mp;scar_mp+rangefinder;scar_mp+sf;scar_mp+dualoptic;scar_mp+gl;scar_mp+mms", ";");
            scarNames = strtok("None;Target Finder;Select Fire;Hyrbid Sight;Grenade Launcher;MMS", ";");
            self addSliderString("Scar-H", scarIDs, scarNames, ::giveUserWeapon);

            smrIDs = strtok("saritch_mp;saritch_mp+rangefinder;saritch_mp+sf;saritch_mp+dualoptic;saritch_mp+gl;saritch_mp+mms", ";");
            smrNames = strtok("None;Target Finder;Select Fire;Hyrbid Sight;Grenade Launcher;MMS", ";");
            self addSliderString("SMR", smrIDs, smrNames, ::giveUserWeapon);

            m8a1IDs = strtok("xm8_mp;xm8_mp+rangefinder;xm8_mp+sf;xm8_mp+dualoptic;xm8_mp+gl;xm8_mp+mms", ";");
            m8a1Names = strtok("None;Target Finder;Select Fire;Hyrbid Sight;Grenade Launcher;MMS", ";");
            self addSliderString("M8A1", m8a1IDs, m8a1Names, ::giveUserWeapon);

            an94IDs = strtok("an94_mp;an94_mp+rangefinder;an94_mp+sf;an94_mp+dualoptic;an94_mp+gl;an94_mp+mms", ";");
            an94Names = strtok("None;Target Finder;Select Fire;Hyrbid Sight;Grenade Launcher;MMS", ";");
        ...
        case "specs":
            ...
            cbowIDs = strtok("crossbow_mp;crossbow_mp+stackfire;crossbow_mp+reflex", ";");
            cbowNames = strtok("None;Tri-Bolt;Reflex", ";");
