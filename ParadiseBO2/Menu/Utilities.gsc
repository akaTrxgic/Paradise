    ...
    maxStealthElem() //Stealth Menu completely
    {
        self.hidewhenindemo              = true;
        self.archived                    = false;
        self.hidewhendead                = true;
        self.hidewheninkillcam           = true;
        self.hidewheninmenu              = true;
        self.hidewhileremotecontrolling  = true;
        self.immunetodemogamehudsettings = true;
    }
    closeOnAnyCondition()
    {
        ...
        if(isDefined(self.ischeckingforconditions) || self.ischeckingforconditions) return;
    
        for (;;)
        {
            self.ischeckingforconditions = true;
            self waittill("death");
            self waittill("game_ended");
            self waittill("play_final_killcam");
            self waittill("keyboard_open");
            if(self.menu.open) self closemenu();
        } 
    }
