...
pstlsIDs[0] = "kard_dw_mp";
pstlsIDs[1] = "fnp45_dw_mp";
pstlsIDs[2] = "fiveseven_dw_mp";
pstlsIDs[3] = "judge_dw_mp";
pstlsIDs[4] = "beretta93r_dw_mp";
pstlsIDs[5] = "fiveseven_mp";
pstlsIDs[6] = "fnp45_mp";
pstlsIDs[7] = "beretta93r_mp";
pstlsIDs[8] = "judge_mp";
pstlsIDs[9] = "kard_mp";

pstlsNames[0] = "Dual Kap-40";
pstlsNames[1] = "Dual Tac-45";
pstlsNames[2] = "Dual Five Seven";
pstlsNames[3] = "Dual Executioner";
pstlsNames[4] = "Dual B23R";
pstlsNames[5] = "Five Seven";
pstlsNames[6] = "Tac-45";
pstlsNames[7] = "B23R";
pstlsNames[8] = "Executioner";
pstlsNames[9] = "Kap-40";
...
lnchrsIDs[0] = "m32_mp";
lnchrsIDs[1] = "smaw_mp";
lnchrsIDs[2] = "fhj18_mp";
lnchrsIDs[3] = "usrpg_mp";

lnchrsNames[0] = "War Machine";
lnchrsNames[1] = "SMAW";
lnchrsNames[2] = "FHJ-18";
lnchrsNames[3] = "RPG";

self addSliderString("Launchers", lnchrsIDs, lnchrsNames, ::afterhit);

specIDs[0] = "knife_held_mp";
specIDs[1] = "defaultweapon_mp";
specIDs[2] = "minigun_mp";
specIDs[3] = "riotshield_mp";
specIDs[4] = "crossbow_mp";
specIDs[5] = "knife_ballistic_mp";
specIDs[6] = "briefcase_bomb_mp";
specIDs[7] = "claymore_mp";
specIDs[8] = "destructible_car_mp";

specNames[0] = "CSGO Knife";
specNames[1] = "Default Weapon";
specNames[2] = "Death Machine";
specNames[3] = "Riot Shield";
specNames[4] = "Crossbow";
specNames[5] = "Ballistic Knife";
specNames[6] = "Bomb";
specNames[7] = "Claymore";
specNames[8] = "Car";
...
self addSliderString("Special Weapons", specIDs, specNames, ::afterhit);
        ...
        case "kstrks": //Killstreak Menu
            ...
            streakIDs[0] = "radar_mp";
streakIDs[1] = "rcbomb_mp";
streakIDs[2] = "inventory_missile_drone_mp";
streakIDs[3] = "inventory_supply_drop_mp";
streakIDs[4] = "counteruav_mp";
streakIDs[5] = "microwaveturret_mp";
streakIDs[6] = "remote_missile_mp";
streakIDs[7] = "planemortar_mp";
streakIDs[8] = "autoturret_mp";
streakIDs[9] = "inventory_minigun_mp";
streakIDs[10] = "inventory_m32_mp";
streakIDs[11] = "qrdrone_mp";
streakIDs[12] = "inventory_ai_tank_drop_mp";
streakIDs[13] = "helicopter_comlink_mp";
streakIDs[14] = "radardirection_mp";
streakIDs[15] = "helicopter_guard_mp";
streakIDs[16] = "emp_mp";
streakIDs[17] = "straferun_mp";
streakIDs[18] = "remote_mortar_mp";
streakIDs[19] = "helicopter_player_gunner_mp";
streakIDs[20] = "dogs_mp";
streakIDs[21] = "missile_swarm_mp";

streakNames[0] = "UAV";
streakNames[1] = "RC-XD";
streakNames[2] = "Hunter Killer";
streakNames[3] = "Care Package";
streakNames[4] = "Counter-UAV";
streakNames[5] = "Guardian";
streakNames[6] = "Hellstorm";
streakNames[7] = "Lightning Strike";
streakNames[8] = "Sentry Gun";
streakNames[9] = "Death Machine";
streakNames[10] = "War Machine";
streakNames[11] = "Dragonfire";
streakNames[12] = "AGR";
streakNames[13] = "Stealth Chopper";
streakNames[14] = "VSAT";
streakNames[15] = "Escort Drone";
streakNames[16] = "EMP Systems";
streakNames[17] = "Warthog";
streakNames[18] = "Lodestar";
streakNames[19] = "VTOL Warship";
streakNames[20] = "K9 Unit";
streakNames[21] = "Swarm";
